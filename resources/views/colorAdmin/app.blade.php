...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		<!-- begin #header -->
		@include('colorAdmin.includes.header')
		<!-- end #header -->
		
		<!-- begin #sidebar -->
		@include('colorAdmin.includes.sidebar')
			...
			<div class="row">
				...
				<div class="col-xl-4 col-lg-6">
					...
					<div class="card border-0 mb-3 bg-dark-darker text-white">
						<!-- begin card-body -->
						<div class="card-body" style="background: no-repeat bottom right; background-image: url({{ asset('colorAdmin/img/svg/img-4.svg')}}); background-size: auto 60%;">
							<!-- begin title -->
							<div class="mb-3 text-grey">
						...
						<div class="card-body">
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url({{ asset('colorAdmin/img/product/product-8.jpg')}}) center no-repeat; background-size: auto 100%;"></div>
								</div>
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url({{ asset('colorAdmin/img/product/product-9.jpg')}}) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url({{ asset('colorAdmin/img/product/product-10.jpg')}}) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url({{ asset('colorAdmin/img/product/product-11.jpg')}}) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
							...
							<div class="d-flex align-items-center">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url({{ asset('colorAdmin/img/product/product-12.jpg')}}) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
					...
					<div class="card border-0 mb-3 bg-dark text-white">
						...
						<div class="card-body">
							...
							<div class="row align-items-center p-b-1">
								...
								<div class="col-4">
									<div class="height-100 d-flex align-items-center justify-content-center">
										<img src="{{ asset('colorAdmin/img/svg/img-2.svg')}}" class="mw-100 mh-100" />
									</div>
								</div>
								<!-- end col-4 -->
								<!-- begin col-8 -->
							...
							<div class="row align-items-center">
								...
								<div class="col-4">
									<div class="height-100 d-flex align-items-center justify-content-center">
										<img src="{{ asset('colorAdmin/img/svg/img-3.svg')}}" class="mw-100 mh-100" />
									</div>
								</div>
								<!-- end col-4 -->
								<!-- begin col-8 -->
